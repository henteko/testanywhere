...
public class TestAnywhereActivity extends Activity {
	...
	public void onCreate(Bundle bundle) {
		...
		String facebookAccessToken = facebookPrefs.getString(Constants.FACEBOOK_ACCESS_TOKEN, null);
		
		long facebookAcessExpires = facebookPrefs.getLong(Constants.FACEBOOK_ACCESS_EXPIRES, 0);
